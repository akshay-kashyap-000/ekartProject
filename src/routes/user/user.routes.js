...
import { changePassword, currentUser, forgotPassword, loginUser, logoutUser, registerUser, resendEmailVerificationLink, resetPassword, updateProfile, verifyEmail } from "../../controllers/user/user.controller.js";
import { validate } from "../../middlewares/validate.middleware.js";
import { forgotPasswordSchema, loginSchema, registerSchema, resendEmailVerificationLinkSchema, resetPasswordSchema, updatePasswordSchema, updateProfileSchema } from './../../validators/user.validator.js';
